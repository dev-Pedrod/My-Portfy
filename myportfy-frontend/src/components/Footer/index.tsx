        ...
        <Styled.FooterLinksContainer>
          <Styled.FooterLinksWrapper>
            <Styled.FooterLinksItems>
              ...
              <Styled.FooterLink href='https://www.linkedin.com/in/pedrooliveiradev/'
                                 target={"_blank"}>...</Styled.FooterLink>
              <Styled.FooterLink href='https://github.com/dev-Pedrod' target={"_blank"}>...</Styled.FooterLink>
            </Styled.FooterLinksItems>
            <Styled.FooterLinksItems>
              <Styled.FooterLinkTitle>Ilustrações</Styled.FooterLinkTitle>
              <Styled.FooterLink href="https://undraw.co/illustrations" target={"_blank"}>unDraw</Styled.FooterLink>
            </Styled.FooterLinksItems>
            <Styled.FooterLinksItems>
              <Styled.FooterLinkTitle>Desenvolvedor</Styled.FooterLinkTitle>
              <Styled.FooterLink href='https://www.linkedin.com/in/pedrooliveiradev/'
                                 target={"_blank"}> Linkedin</Styled.FooterLink>
            ...
            <Styled.FooterLinksItems>
              ...
              <Styled.FooterLink href='https://github.com/dev-Pedrod/My-Portfy'
                                 target={"_blank"}> Código-fonte</Styled.FooterLink>
            </Styled.FooterLinksItems>
          </Styled.FooterLinksWrapper>
        </Styled.FooterLinksContainer>
        <Styled.SocialMedia>
